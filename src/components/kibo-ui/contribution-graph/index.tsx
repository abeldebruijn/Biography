      ...
      >
        ...
        {weeks.map((week, weekIndex) =>
          week.map((activity, dayIndex) => {
            ...
            return (
              // biome-ignore lint/suspicious/noArrayIndexKey: <explanation>"Using weekIndex and dayIndex as key is acceptable here because the data is static and won't change during the component's lifecycle, thus avoiding potential issues with dynamic keys."</explanation>
  ...
  return (
    ...
    >
      ...
      {new Array(maxLevel + 1).fill(undefined).map((_, level) =>
        children ? (
          // biome-ignore lint/suspicious/noArrayIndexKey: <explanation>"Using level as key is acceptable here because the number of levels is fixed and won't change during the component's lifecycle, thus avoiding potential issues with dynamic keys."</explanation>
