...
This most definitely does not mean I am a senior developer. This is only one persons (Steve Huynh) opinion based on my own experience. My own experience comes with a strong bias towards seniority. However it does mean I have a strong sense of responsibility and accountability for the projects I work on. Working on multiple projects simultaneously has allowed me to learn and grow as a developer, and to work on projects that are meaningful to students and teachers alike. If you are interested in learning more about my work, please feel free to visit my GitHub or linkedin profile to see my projects.
