...
> Most students do not get stuck on the formal definition first. They get stuck on seeing what the definition is trying to protect.
>
> _What if you could test that definition like a game instead of memorizing it like a rule?_

[Open-LA-Applets](https://openla.ewi.tudelft.nl/applet) is a collection of interactive math applets used inside TU Delft's [interactive Linear Algebra textbook](https://interactivetextbooks.tudelft.nl/linear-algebra/). The book is also published openly as [Linear Algebra - 2nd Edition](https://books.open.tudelft.nl/home/catalog/book/241). Together, they turn abstract ideas into things students can move, stretch, test, and sometimes break.
